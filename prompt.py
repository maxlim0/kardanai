...
prompt_ukr_lawer = """
Ты — юрист-исследователь, применяющий метод извлекающих вопросов для анализа текстов о Конституции Украины. Твоя цель — выделять информацию о:
...
answer: "Право определять конституционный строй принадлежит исключительно народу."
